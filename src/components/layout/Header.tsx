  ...
  return (
    <header className="sticky top-0 z-50 bg-surface/90 backdrop-blur-md border-b border-border/60 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        <Link href="/" className="font-serif text-xl md:text-2xl font-bold text-primary tracking-wide hover:opacity-80 transition-opacity">
        ...
        <Link href="#booking" className="bg-primary text-panel px-4 md:px-7 py-2.5 rounded-full text-xs md:text-sm font-medium shadow-sm hover:shadow-lg hover:-translate-y-0.5 hover:bg-primary/90 transition-all duration-300 flex items-center gap-2">
          🗓️ Book Now <span className="font-normal hidden md:block">(จองคิว)</span>
        </Link>
      </div>
    </header>
  );
